...
portfolios = [
    ("bsc", [ # tracked by bogged.finance charts (make sure the contract addresses are trackable on the website)
    ...
    ("eth", [ # tracked by dextools.io charts (make sure the contract addresses are trackable on the website)
